        ...
        <section>
            <section id="future">
                ...
                <div class="cartegory-right-content row">
                    ...
                    $sql = "SELECT * FROM ttxe WHERE Maxe>=6 AND Maxe<=9";
                ...
                <section>
                    <section id="vario">
                        ...
                        <div class="cartegory-right-content row">
                            ...
                            // Truy vấn lấy dữ liệu từ bảng xe
                            $sql = "SELECT * FROM ttxe WHERE Maxe>=12 AND Maxe<=15";
                            $result = $conn->query($sql);
                        ...
                        <section>
                            <section id="vario">
                                ...
                                <div class="cartegory-right-content row">
                                    ...
                                    // Truy vấn lấy dữ liệu từ bảng xe
                                    $sql = "SELECT * FROM ttxe WHERE Maxe>=16 AND Maxe<=19";
                                    $result = $conn->query($sql);
                                ...
                                <section>
                                    <section id="winnerx">
                                        ...
                                        <div class="cartegory-right-content row">
                                            ...
                                            // Truy vấn lấy dữ liệu từ bảng xe
                                            $sql = "SELECT * FROM ttxe WHERE Maxe>=24 AND Maxe<=28";
                                            $result = $conn->query($sql);
                                        ...
                                        <section>
                                            <section id="wave">
                                                ...
                                                <div class="cartegory-right-content row">
                                                    ...
                                                    // Truy vấn lấy dữ liệu từ bảng xe
                                                    $sql = "SELECT * FROM ttxe WHERE Maxe>=20 AND Maxe<=23";
                                                    $result = $conn->query($sql);
                                                ...
                                                <section>
                                                    <section id="airblade">
                                                        ...
                                                        <div class="cartegory-right-content row">
                                                            ...
                                                            // Truy vấn lấy dữ liệu từ bảng xe
                                                            $sql = "SELECT * FROM ttxe WHERE Maxe>=1 AND Maxe<=3";
                                                            $result = $conn->query($sql);
