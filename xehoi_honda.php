        ...
        <section>
            <section id="accord">
                ...
                <div class="cartegory-right-content row">
                    ...
                    $sql = "SELECT * FROM ttxe WHERE Maxe>=98 AND Maxe<=99";
                ...
                <section>
                    <section id="city">
                        ...
                        <div class="cartegory-right-content row">
                            ...
                            // Truy vấn lấy dữ liệu từ bảng xe
                            $sql = "SELECT * FROM ttxe WHERE Maxe>=100 AND Maxe<=101";
                            $result = $conn->query($sql);
                        ...
                        <section>
                            <section id="civic">
                                ...
                                <div class="cartegory-right-content row">
                                    ...
                                    // Truy vấn lấy dữ liệu từ bảng xe
                                    $sql = "SELECT * FROM ttxe WHERE Maxe>=102 AND Maxe<=104";
                                    $result = $conn->query($sql);
                                ...
                                <section>
                                    <section id="crv">
                                        ...
                                        <div class="cartegory-right-content row">
                                            ...
                                            // Truy vấn lấy dữ liệu từ bảng xe
                                            $sql = "SELECT * FROM ttxe WHERE Maxe>=105 AND Maxe<=107";
                                            $result = $conn->query($sql);
