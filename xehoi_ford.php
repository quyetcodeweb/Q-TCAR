...
<section id="fordEdge">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng ttxe
		$sql = "SELECT * FROM ttxe WHERE Maxe>=86 AND Maxe<=87";
...
<section id="fordEscape">
    ...
    <div class="cartegory-right-content row">
		...
		$sql = "SELECT * FROM ttxe WHERE Maxe>=88 AND Maxe<=89";
        $result = $conn->query($sql);
...
<section id="fordExplorer">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM ttxe WHERE Maxe>=90 AND Maxe<=91";
        $result = $conn->query($sql);
...
<section id="fordF150">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM ttxe WHERE Maxe>=92 AND Maxe<=93";
        $result = $conn->query($sql);
...
<section id="fordFocus">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM ttxe WHERE Maxe>=94 AND Maxe<=95";
        $result = $conn->query($sql);
...
<section id="fordRanger">
    ...
    <div class="cartegory-right-content row">
        ...
        // Truy vấn lấy dữ liệu từ bảng xe
		$sql = "SELECT * FROM ttxe WHERE Maxe>=96 AND Maxe<=97";
        $result = $conn->query($sql);
...
<?php
			...
			if (isset($_POST['yeuthich']) && isset($_POST['id'])) {
				...
				echo "ID hoặc yêu thích không được gửi!";
			}
